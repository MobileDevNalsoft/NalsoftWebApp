...
document.addEventListener('DOMContentLoaded', function() {
  ...
  toggle.addEventListener('click', function() {
    ...
    // Smooth scroll to header section after toggling theme
    try {
      var headerEl = document.querySelector('.tekprof-site-header') || document.querySelector('.main-header') || document.body;
